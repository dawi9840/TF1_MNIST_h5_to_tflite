...
This is example about using TF1 to train MNIST dataset saving HDF5 parameter and convert to TFLite file with CPU and GPU. However, I not sure the TFlite can work or not.😢
